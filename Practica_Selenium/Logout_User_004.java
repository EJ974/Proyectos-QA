...
public class Logout_User_004 {
    ...
    public void registerTest() {
	        ...
	        WebElement accountcreated = wait3.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#form > div > div > div.col-sm-4.col-sm-offset-1 > div > h2")));
